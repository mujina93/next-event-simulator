...
validation_interval_results RunSimulations(int number_of_runs, builder SystemBuilderFunction, System* burn_in_system, double max_time, int min_reg_points, double prob, double precision, int agglomeration);
...
int main(){
    ...
    /// true runs
    validation_interval_results Results = RunSimulations(100, approximateSystemNoMPD, test_sys, 1000000000, 10, 0.9, 0.1, 50);
    // cleanup
    delete test_sys;
...
validation_interval_results RunSimulations(int number_of_runs,
    ...
    for(int i=0; i<number_of_runs; i++){
        ...
        sys->simulate(max_time, min_reg_points, prob, precision, agglomeration);
